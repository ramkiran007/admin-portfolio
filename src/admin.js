...
function AdminView({ handleResumeUpload, handleImageUpload,formData,setFormData, fetchPortfolioDetails, handleRemoveImage ,portfolioDetails}) {
  ...
  const handleRemove = async (id, type) => {
    try {
      await fetch(`https://ramkiranmeduri.azurewebsites.net/api/portfolio/remove/${id}`, { method: 'DELETE' });
  ...
  const handleSubmit = async (e) => {
    ...
    let url = isUpdateOperation ? `https://ramkiranmeduri.azurewebsites.net/api/portfolio/update/${editId}` : 'https://ramkiranmeduri.netlify.app/api/portfolio/add';
