...
function App() {
  ...
  useEffect(() => {
   ...
   const fetchPortfolioDetails = async () => {
    try {
      const response = await fetch('https://ramkiranmeduri.azurewebsites.net/api/portfolio/items');
      if (response.ok) {
  ...
  const handleImageUpload = async (e) => {
   ...
   setPortfolioDetails(prev => ({ ...prev, image: file }));  // Save the file to formData
    ...
    try {
        const response = await fetch('https://ramkiranmeduri.azurewebsites.net/api/portfolio/add', {
            method: 'POST',
...
const handleResumeUpload = async (e) => {
  ...
  try {
    const response = await fetch('https://ramkiranmeduri.azurewebsites.net/api/portfolio/add', { // Make sure this URL is correct for your API
      method: 'POST',
      body: formData, // Send formData directly
...
/*
  ...
  */
  ...
  const handleRemoveImage = async () => {
    ...
    try {
        const response = await fetch('https://ramkiranmeduri.azurewebsites.net/remove-image', {
